  ...
  >
    <input
        ...
        cn(
          ...
          file:text-sm file:font-medium placeholder:text-neutral-400 dark:placeholder:text-booktopia-font
          focus-visible:outline-none focus-visible:ring-[3px]  focus-visible:ring-neutral-400 dark:focus-visible:ring-booktopia-green
